...
public class VentanaOpcionesComprarTiquetesEmpleados extends JFrame{
public VentanaOpcionesComprarTiquetesEmpleados() {
		...
		btnComprar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (nombre.isEmpty()) {
					JOptionPane.showMessageDialog(VentanaOpcionesComprarTiquetesEmpleados.this, "El campo 'Nombre de cliente' es obligatorio.", "Error", JOptionPane.ERROR_MESSAGE);
					return;
				}
				else {
					...
					JOptionPane.showMessageDialog(VentanaOpcionesComprarTiquetesEmpleados.this, "Tu compra se realizo con exito");
	                dispose();
				}
			}
		});
